...
%                           observed, a value (j-1)*n+i is recorded in
%                           Omega_linear.  记录矩阵中有1的一维下标
%           A             - the side information matrix where left singular
%                           vectores lie in. 
%           B             - the side information matrix where right singular 
%                           vectores lie in.
%           lambda        - the regularization parameter 正则化参数
%           max_iter      - maximum number of iterations 最大的循环参数
%      and returns,
